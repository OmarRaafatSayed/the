...
const images = [
  {
    src: "/images/conservation/completion/mashrabiya-1.jpeg",
    alt: "Mashrabiya 1 — Wooden Beams Completion",
    label: "Mashrabiya 1",
  },
  {
    src: "/images/conservation/completion/mashrabiya-2.jpeg",
    alt: "Mashrabiya 2 — Wooden Beams Completion",
    label: "Mashrabiya 2",
  },
];
    ...
    >
      ...
      <AnimatedSection>
        <div className="flex flex-col items-center text-center mb-14">
          ...
          >
            Completion of Wooden Beams for{" "}
      ...
      <AnimatedSection delay={0.3}>
        ...
        >
          ...
          >
            Phase_IV · Wooden_Beams_Completion
          </span>
          <div
            style={{
              height: "1px",
